...
public class ItemShrinkDisc extends Item {
	public ItemShrinkDisc(String unlocalizedName, String registryName) {
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player,
			EnumHand hand) {
		EntityShrinkDisc projectile = new EntityShrinkDisc(world, player);
	    if (!world.isRemote) {
