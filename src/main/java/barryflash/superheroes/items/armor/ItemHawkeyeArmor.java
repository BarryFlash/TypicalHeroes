...
public class ItemHawkeyeArmor extends ArmorBase {

	private static ModelHawkeye model;
	
	public ItemHawkeyeArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn,
...

	{
		...
		return !player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == ModItems.HawkeyeChest

				&& !player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).getItem() == ModItems.HawkeyeLegs

				&& !player.getItemStackFromSlot(EntityEquipmentSlot.FEET).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == ModItems.HawkeyeBoots;
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		...
		return Reference.MODID + ":textures/models/armor/hawkeye.png";
	}
	@SideOnly(Side.CLIENT)
	public ModelBiped getModelHawkeye(ItemStack stack, Entity entity, EntityEquipmentSlot slot) {
		if (model == null) {
			model = new ModelHawkeye(Helper.getArmorModelScale(slot));
		}
		return model;
	}
	@Override
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack stack, EntityEquipmentSlot slot, ModelBiped _default) {
		...
		if (stack != null) {
			armorModel = getModelHawkeye(stack, entityLiving, slot);
			if (armorModel != null) {
