...
public class ItemBatmanArmor extends ArmorBase {
	private static ModelBatman model;
	
	public ItemBatmanArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn,
	...
	public static boolean isWearingFullSet(EntityPlayer player, Item BatmanCowl, Item BatmanChest, Item BatmanLeggings, Item BatmanBoots)

	{
		
		return !player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() instanceof ItemBatmanArmor 

				&& !player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() instanceof ItemBatmanArmor

				&& !player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).getItem() instanceof ItemBatmanArmor

				&& !player.getItemStackFromSlot(EntityEquipmentSlot.FEET).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof ItemBatmanArmor;
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		...
		return Reference.MODID + ":textures/models/armor/batman_layer_" + (slot == slot.LEGS ? "2" : "1") + ".png";
	}
