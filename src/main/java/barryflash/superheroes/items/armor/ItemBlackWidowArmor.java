...
public class ItemBlackWidowArmor extends ArmorBase {
	
	private static ModelBlackWidow model;
	
	public ItemBlackWidowArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn,
...

	{
		...
		return !player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == ModItems.BlackWidowChest

				&& !player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).getItem() == ModItems.BlackWidowLegs

				&& !player.getItemStackFromSlot(EntityEquipmentSlot.FEET).isEmpty() && player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == ModItems.BlackWidowBoots;
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		...
		return Reference.MODID + ":textures/models/armor/blackwidow.png";
	}
	@SideOnly(Side.CLIENT)
	public ModelBiped getModelBlackWidow(ItemStack stack, Entity entity, EntityEquipmentSlot slot) {
		if (model == null) {
			model = new ModelBlackWidow(Helper.getArmorModelScale(slot));
		}
		return model;
	}
	@Override
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack stack, EntityEquipmentSlot slot, ModelBiped _default) {
		...
		if (stack != null) {
			armorModel = getModelBlackWidow(stack, entityLiving, slot);
			if (armorModel != null) {
