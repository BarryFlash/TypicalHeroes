...
public class ProjectileRenderMissile extends Render<EntityMissile> {



	private ModelBase model = new ModelIronManMark50Missile();



	public ProjectileRenderMissile(RenderManager renderManager) {
	...
	public ProjectileRenderMissile(RenderManager renderManager, ModelBase model) {
	...
	protected ResourceLocation getEntityTexture(EntityMissile entity) {
		...
		return new ResourceLocation(Reference.MODID, "textures/models/armor/IronMan_layer_1.png");
