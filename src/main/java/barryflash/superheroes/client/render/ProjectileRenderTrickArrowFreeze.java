...
public class ProjectileRenderTrickArrowFreeze extends Render<EntityTrickArrowFreeze> {


	private ModelBase model = new ModelTrickArrowWithContainer();

	public ProjectileRenderTrickArrowFreeze(RenderManager renderManager) {
		super(renderManager);
	}


	public ProjectileRenderTrickArrowFreeze(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	@Override
	public void doRender(EntityTrickArrowFreeze entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrickArrowFreeze entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/trick_arrow_freeze.png");
	}
