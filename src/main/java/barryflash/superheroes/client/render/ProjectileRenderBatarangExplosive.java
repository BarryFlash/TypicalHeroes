...
public class ProjectileRenderBatarangExplosive extends Render<EntityBatmanBatarangExplosive> {
	...
	public ProjectileRenderBatarangExplosive(RenderManager renderManager) {
	...
	public ProjectileRenderBatarangExplosive(RenderManager renderManager, ModelBase model) {
	...
	public void doRender(EntityBatmanBatarangExplosive entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	protected ResourceLocation getEntityTexture(EntityBatmanBatarangExplosive entity) {

		return new ResourceLocation(Reference.MODID, "textures/models/batarang_explosive.png");
