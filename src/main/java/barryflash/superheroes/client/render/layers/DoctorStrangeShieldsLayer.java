...
public class DoctorStrangeShieldsLayer implements LayerRenderer<AbstractClientPlayer> {

	 protected final RenderHero playerrenderer;

	    public DoctorStrangeShieldsLayer(RenderHero playerrendererIn)
	    {
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Reference.MODID + ":textures/items/doctorstrange_shield.png"));
		OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, 240.0F, 240.0F);
		GlStateManager.color(1F, 0.6F, 0F, 1F);
		this.renderHeldItem(entitylivingbaseIn, new ItemStack(ModItems.doctorstrange_shields), ItemCameraTransforms.TransformType.THIRD_PERSON_RIGHT_HAND, EnumHandSide.RIGHT);
		this.renderHeldItem(entitylivingbaseIn, new ItemStack(ModItems.doctorstrange_shields), ItemCameraTransforms.TransformType.THIRD_PERSON_LEFT_HAND, EnumHandSide.LEFT);
