...
public class RenderEntityDoctorStrangeCape extends RenderLiving<EntityDoctorStrangeCape> {
		...
		public RenderEntityDoctorStrangeCape(RenderManager rendermanagerIn) {
		...
		@Override
		protected ResourceLocation getEntityTexture(EntityDoctorStrangeCape entity) {
			return this.capeTexture;
		}
		  public static class Factory implements IRenderFactory<EntityDoctorStrangeCape> {



		        @Override

		        public Render<? super EntityDoctorStrangeCape> createRenderFor(RenderManager manager) {

		            return new RenderEntityDoctorStrangeCape(manager);
