...
import barryflash.superheroes.models.ModelTrickArrowGrapple;
import barryflash.superheroes.models.ModelTrickArrowWithContainer;
...
public class ProjectileRenderTrickArrowGrapple extends Render<EntityTrickArrowGrapple> {


	private ModelBase model = new ModelTrickArrowGrapple();

	public ProjectileRenderTrickArrowGrapple(RenderManager renderManager) {
		super(renderManager);
	}


	public ProjectileRenderTrickArrowGrapple(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	@Override
	public void doRender(EntityTrickArrowGrapple entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrickArrowGrapple entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/trick_arrow_grapple.png");
	}
