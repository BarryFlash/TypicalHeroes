...
import barryflash.superheroes.models.ModelPlayerCustom;
import barryflash.superheroes.util.EnumActionCustom;
...
public class RenderEntityPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    public RenderEntityPlayer(RenderManager renderManager, boolean useSmallArms)
    {
        super(renderManager, new ModelPlayerCustom(), 0.5F);
    ...
    public void rotateCorpse(AbstractClientPlayer entityLiving, float p_77043_2_, float p_77043_3_, float partialTicks)
    {
