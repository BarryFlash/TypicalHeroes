...
public class ProjectileRenderTrickArrowTranquilizer extends Render<EntityTrickArrowTranquilizer> {


	private ModelBase model = new ModelTrickArrowWithContainer();

	public ProjectileRenderTrickArrowTranquilizer(RenderManager renderManager) {
		super(renderManager);
	}


	public ProjectileRenderTrickArrowTranquilizer(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	@Override
	public void doRender(EntityTrickArrowTranquilizer entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrickArrowTranquilizer entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/trick_arrow_tranquilizer.png");
	}
