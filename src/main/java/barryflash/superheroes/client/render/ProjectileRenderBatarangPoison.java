...
import barryflash.superheroes.models.ModelBatarangPoison;
...
public class ProjectileRenderBatarangPoison extends Render<EntityBatmanBatarangPoison> {



	private ModelBase model = new ModelBatarangPoison();



	public ProjectileRenderBatarangPoison(RenderManager renderManager) {
	...
	public ProjectileRenderBatarangPoison(RenderManager renderManager, ModelBase model) {
	...
	public void doRender(EntityBatmanBatarangPoison entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	protected ResourceLocation getEntityTexture(EntityBatmanBatarangPoison entity) {

		return new ResourceLocation(Reference.MODID, "textures/models/batarang_poison.png");
