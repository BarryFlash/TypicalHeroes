...
import barryflash.superheroes.models.ModelCaptainAmericaShieldProjectile;
...
public class ProjectileRenderCaptainAmericaShield extends Render<EntityCaptainAmericaShield> {

	private ModelBase model = new ModelCaptainAmericaShieldProjectile();

	public ProjectileRenderCaptainAmericaShield(RenderManager renderManager) {
		super(renderManager);
	}

	public ProjectileRenderCaptainAmericaShield(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	protected ResourceLocation getEntityTexture(EntityCaptainAmericaShield entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/armor/cap_shield.png");
	}
}	