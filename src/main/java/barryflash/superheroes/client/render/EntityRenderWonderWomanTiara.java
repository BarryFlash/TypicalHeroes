...
public class EntityRenderWonderWomanTiara extends Render<EntityWonderWomanTiara>
{
    private final float scale;

    public EntityRenderWonderWomanTiara(RenderManager renderManagerIn, float scaleIn)
    {
     ...
     */
    public void doRender(EntityWonderWomanTiara entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityWonderWomanTiara entity)
    {
