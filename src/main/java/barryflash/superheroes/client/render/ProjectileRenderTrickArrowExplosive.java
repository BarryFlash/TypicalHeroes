...
public class ProjectileRenderTrickArrowExplosive extends Render<EntityTrickArrowExplosive> {


	private ModelBase model = new ModelTrickArrowWithContainer();

	public ProjectileRenderTrickArrowExplosive(RenderManager renderManager) {
		super(renderManager);
	}


	public ProjectileRenderTrickArrowExplosive(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	@Override
	public void doRender(EntityTrickArrowExplosive entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrickArrowExplosive entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/trick_arrow_explosive.png");
	}
