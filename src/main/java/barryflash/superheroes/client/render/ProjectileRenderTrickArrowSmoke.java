...
public class ProjectileRenderTrickArrowSmoke extends Render<EntityTrickArrowSmoke> {


	private ModelBase model = new ModelTrickArrowWithContainer();

	public ProjectileRenderTrickArrowSmoke(RenderManager renderManager) {
		super(renderManager);
	}


	public ProjectileRenderTrickArrowSmoke(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	@Override
	public void doRender(EntityTrickArrowSmoke entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrickArrowSmoke entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/trick_arrow_smoke.png");
	}
