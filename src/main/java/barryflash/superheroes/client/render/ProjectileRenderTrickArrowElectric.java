...
public class ProjectileRenderTrickArrowElectric extends Render<EntityTrickArrowElectric> {


	private ModelBase model = new ModelTrickArrowWithContainer();

	public ProjectileRenderTrickArrowElectric(RenderManager renderManager) {
		super(renderManager);
	}


	public ProjectileRenderTrickArrowElectric(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	@Override
	public void doRender(EntityTrickArrowElectric entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrickArrowElectric entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/trick_arrow_electric.png");
	}
