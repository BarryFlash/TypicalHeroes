...
public class ProjectileRenderTrickArrowKryptonite extends Render<EntityTrickArrowKryptonite> {


	private ModelBase model = new ModelTrickArrowWithContainer();

	public ProjectileRenderTrickArrowKryptonite(RenderManager renderManager) {
		super(renderManager);
	}


	public ProjectileRenderTrickArrowKryptonite(RenderManager renderManager, ModelBase model) {
		this(renderManager);
		this.model = model;
	}
	...
	@Override
	public void doRender(EntityTrickArrowKryptonite entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTrickArrowKryptonite entity) {
		return new ResourceLocation(Reference.MODID, "textures/models/trick_arrow_kryptonite.png");
	}
