...
public class EntityAnt extends EntityTameable
{
	...
	public void onLivingUpdate() {
		 if (this.isBeingRidden()) {
      	   ...
      	   this.motionY += 0.08499999910593033D;
      	 if (this.getOwner().moveForward > 0.001F) {
      	   this.motionY = vec.y / 2;
      	 }
      	   }
      	   if (this.getOwner().moveForward > 0.001F) {
      		 

      		 this.motionX = vec.x / 2;

      		

      		this.motionZ = vec.z / 2;
	...
	public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
        ...
        {
		 if (p_142018_1_ instanceof EntityAnt)
         {
			 EntityAnt entitycape = (EntityAnt)p_142018_1_;
