...
public class EntityBlackWidowBite extends EntityThrowable {

	
	public EntityBlackWidowBite(World WorldIn) {
		super(WorldIn);
		float size = 0.2F;
		this.setSize(size, size);
	}

	public EntityBlackWidowBite(World WorldIn, EntityLivingBase throwerIn) {
		super(WorldIn, throwerIn);
		
	}

	public EntityBlackWidowBite(World WorldIn, double x, double y, double z) {
		super(WorldIn, x, y, z);
	}
