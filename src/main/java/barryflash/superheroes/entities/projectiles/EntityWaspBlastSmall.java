...
public class EntityWaspBlastSmall extends EntityThrowable {
	public EntityWaspBlastSmall(World WorldIn) {
	...
	public EntityWaspBlastSmall(World WorldIn, EntityLivingBase throwerIn) {

		super(WorldIn, throwerIn);

	}

	public EntityWaspBlastSmall(World WorldIn, double x, double y, double z) {
	...
	public void onEntityUpdate() {
		...
		ParticleSpawnerDoctorStrangeShields.spawnParticle("waspS", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D, null);
		ParticleSpawnerDoctorStrangeShields.spawnParticle("waspS2", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D, null);
		}
...

   {
       ...
       this.posY = entityThrower.posY + 0.3F;
       ...
       double sposY = entityThrower.posY + 0.2 + (sdistance * -Math.sin(playerPitch));
       ...
       double spos2Y = entityThrower.posY + 0.2 + (sdistance * -Math.sin(playerPitch));
