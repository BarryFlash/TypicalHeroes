...
public class EntityUnibeam extends EntityThrowable {
	public EntityUnibeam(World WorldIn) {
	...
	public EntityUnibeam(World WorldIn, EntityLivingBase throwerIn) {

		super(WorldIn, throwerIn);

	}

	public EntityUnibeam(World WorldIn, double x, double y, double z) {
		...
		if (!world.isRemote) {
			...
			if (result.entityHit != null) {
				...
				if (result.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), 20)) {
					...
					result.entityHit.addVelocity(this.motionX * 1.8000000238418579D, 0.6,this.motionZ * 1.8000000238418579D);
