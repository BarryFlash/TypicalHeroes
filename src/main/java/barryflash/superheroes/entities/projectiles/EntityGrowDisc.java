...
import barryflash.superheroes.capabilities.SizeEventHandler;
import barryflash.superheroes.capabilities.SizeProvider;
...
public class EntityGrowDisc extends EntityThrowable {
	...
	public EntityGrowDisc(World WorldIn, EntityLivingBase throwerIn) {
	...
	protected void onImpact(RayTraceResult result) {
		...
		if (!world.isRemote) {
			if (result.entityHit != null) {
				...
				if (result.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), 2)) {
