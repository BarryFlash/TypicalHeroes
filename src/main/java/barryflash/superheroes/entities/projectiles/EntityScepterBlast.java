...
public class EntityScepterBlast extends EntityThrowable {


	public EntityScepterBlast(World WorldIn) {
		super(WorldIn);
		float size = 0.2F;
		this.setSize(size, size);
	}

	public EntityScepterBlast(World WorldIn, EntityLivingBase throwerIn) {
		super(WorldIn, throwerIn);
		
	}

	public EntityScepterBlast(World WorldIn, double x, double y, double z) {
		super(WorldIn, x, y, z);
	}
