...
public class EntityRepulsor extends EntityThrowable {
	public EntityRepulsor(World WorldIn) {
	...
	public EntityRepulsor(World WorldIn, EntityLivingBase throwerIn) {

		super(WorldIn, throwerIn);

	}

	public EntityRepulsor(World WorldIn, double x, double y, double z) {
		...
		if (!world.isRemote) {
			...
			if (result.entityHit != null) {
				...
				if (result.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), 4)) {
					...
					result.entityHit.addVelocity(this.motionX * 0.6000000238418579D, 0.3,this.motionZ * 0.6000000238418579D);
