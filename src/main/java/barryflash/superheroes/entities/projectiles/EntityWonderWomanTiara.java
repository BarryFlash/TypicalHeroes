...
public abstract class EntityWonderWomanTiara extends Entity
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityWonderWomanTiara(World worldIn)
    {
        super(worldIn);
    ...
    public EntityWonderWomanTiara(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityWonderWomanTiara(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
