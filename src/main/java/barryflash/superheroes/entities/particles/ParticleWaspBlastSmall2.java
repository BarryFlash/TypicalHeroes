...
public class ParticleWaspBlastSmall2 extends Particle

{

	public static TextureAtlasSprite blast = ParticleWaspBlast2.blast;
  ...
  public ParticleWaspBlastSmall2(World world, double x, double y, double z,
