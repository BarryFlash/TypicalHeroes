...
public class ParticleWaspBlastSmall extends Particle

{

	public static TextureAtlasSprite blast = ParticleWaspBlast.blast;
  ...
  public ParticleWaspBlastSmall(World world, double x, double y, double z,
