...
public abstract class AbstractSmeltingCrucibleRecipeCategory<T extends IRecipeWrapper> implements IRecipeCategory<T> {
	protected static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID, "textures/gui/sintering_furnace.png");
	...
	public AbstractSmeltingCrucibleRecipeCategory(IGuiHelper helper) {
