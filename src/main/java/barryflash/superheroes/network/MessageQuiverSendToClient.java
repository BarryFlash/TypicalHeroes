...
public class MessageQuiverSendToClient extends MessageBase<MessageQuiverSendToClient> {
	private boolean cap;
	private int selected, id;
	public MessageQuiverSendToClient() {
		// TODO Auto-generated constructor stub
	}
	public MessageQuiverSendToClient(int ID, int selected, boolean cooldown) {
		this.cap = cooldown;
	...
	@Override
	public void handleClientSide(MessageQuiverSendToClient message, EntityPlayer player) {
		IQuiver qcap = Minecraft.getMinecraft().world.getEntityByID(message.id).getCapability(QuiverProvider.QUIVER_CAP, null);
		qcap.setCooldownBoolForArrow(message.selected, message.cap);
		
	}

	@Override
	public void handleServerSide(MessageQuiverSendToClient message, EntityPlayer player, MessageContext ctx) {
