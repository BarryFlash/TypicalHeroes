...
public class MessageSpawnMissiles extends MessageBase<MessageSpawnMissiles> {
	...
	@Override
	public void handleClientSide(MessageSpawnMissiles message, EntityPlayer player) {
		
		
	}

	@Override
	public void handleServerSide(MessageSpawnMissiles message, EntityPlayer playerd, MessageContext ctx) {
		...
		world.addScheduledTask(new Runnable() {
	      ...
	      public void run() {
	     EntityMissile projectile = new EntityMissile(world, player);
