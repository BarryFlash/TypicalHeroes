...
public class MessageAddItemStackToInventoryServer extends MessageBase<MessageAddItemStackToInventoryServer> {
	private ItemStack item;
	public MessageAddItemStackToInventoryServer() {
		// TODO Auto-generated constructor stub
	}
	public MessageAddItemStackToInventoryServer(ItemStack item) {
		this.item = item;
	...
	@Override
	public void handleClientSide(MessageAddItemStackToInventoryServer message, EntityPlayer player) {
		
		
	}

	@Override
	public void handleServerSide(MessageAddItemStackToInventoryServer message, EntityPlayer player, MessageContext ctx) {
		player.addItemStackToInventory(message.item);
