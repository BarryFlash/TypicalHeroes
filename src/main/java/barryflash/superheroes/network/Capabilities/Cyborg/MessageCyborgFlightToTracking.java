...
public class MessageCyborgFlightToTracking extends MessageBase<MessageCyborgFlightToTracking> {
	private boolean cap;
	private int playerID;
	public MessageCyborgFlightToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageCyborgFlightToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageCyborgFlightToTracking message, EntityPlayer player) {
		...
		cyborgcap.setFly(message.cap);
	}

	@Override
	public void handleServerSide(MessageCyborgFlightToTracking message, EntityPlayer player, MessageContext ctx) {
