...
public class MessageCyborgLaserToTracking extends MessageBase<MessageCyborgLaserToTracking> {
	private boolean cap;
	private int playerID;
	public MessageCyborgLaserToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageCyborgLaserToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageCyborgLaserToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageCyborgLaserToTracking message, EntityPlayer player, MessageContext ctx) {
