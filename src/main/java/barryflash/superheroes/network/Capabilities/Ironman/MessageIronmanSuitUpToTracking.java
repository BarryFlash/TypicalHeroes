...
public class MessageIronmanSuitUpToTracking extends MessageBase<MessageIronmanSuitUpToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanSuitUpToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanSuitUpToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanSuitUpToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageIronmanSuitUpToTracking message, EntityPlayer player, MessageContext ctx) {
