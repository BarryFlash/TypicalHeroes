...
public class MessageIronmanFlight3ToTracking extends MessageBase<MessageIronmanFlight3ToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanFlight3ToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanFlight3ToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanFlight3ToTracking message, EntityPlayer player) {
		...
		if (message.cap == true) {
			ironmancap.activateJetThruster();
		} else {
	...
	@Override
	public void handleServerSide(MessageIronmanFlight3ToTracking message, EntityPlayer player, MessageContext ctx) {
