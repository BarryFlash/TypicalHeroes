...
public class MessageIronmanLeftRepulsorToTracking extends MessageBase<MessageIronmanLeftRepulsorToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanLeftRepulsorToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanLeftRepulsorToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanLeftRepulsorToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageIronmanLeftRepulsorToTracking message, EntityPlayer player, MessageContext ctx) {
