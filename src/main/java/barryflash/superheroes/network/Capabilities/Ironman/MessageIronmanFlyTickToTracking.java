...
public class MessageIronmanFlyTickToTracking extends MessageBase<MessageIronmanFlyTickToTracking> {
	private int cap;
	private int playerID;
	public MessageIronmanFlyTickToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanFlyTickToTracking(int cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanFlyTickToTracking message, EntityPlayer player) {
		...
		ironmancap.ticksFlying(message.cap);
	}

	@Override
	public void handleServerSide(MessageIronmanFlyTickToTracking message, EntityPlayer player, MessageContext ctx) {
