...
public class MessageIronmanRepulsorsToTracking extends MessageBase<MessageIronmanRepulsorsToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanRepulsorsToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanRepulsorsToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanRepulsorsToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageIronmanRepulsorsToTracking message, EntityPlayer player, MessageContext ctx) {
