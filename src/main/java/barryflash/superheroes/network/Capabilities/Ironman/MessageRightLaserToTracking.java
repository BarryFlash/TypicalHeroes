...
public class MessageRightLaserToTracking extends MessageBase<MessageRightLaserToTracking> {
	...
	double evecy;
	double evecz;
	public MessageRightLaserToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageRightLaserToTracking(Vec3d svec, Vec3d evec) {
		this.svecx = svec.x;
		this.svecy = svec.y;
		this.svecz = svec.z;
		this.evecx = evec.x;
	...
	@Override
	public void handleClientSide(MessageRightLaserToTracking message, EntityPlayer player) {
		...
		//Utils.renderLaser(S, vector, 3.5F, 0.05F, new float[] {0.8F, 0.5F, 0.3F});
	}

	@Override
	public void handleServerSide(MessageRightLaserToTracking message, EntityPlayer player, MessageContext ctx) {
