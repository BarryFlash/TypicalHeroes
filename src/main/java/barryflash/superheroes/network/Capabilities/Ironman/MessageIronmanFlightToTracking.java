...
public class MessageIronmanFlightToTracking extends MessageBase<MessageIronmanFlightToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanFlightToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanFlightToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanFlightToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageIronmanFlightToTracking message, EntityPlayer player, MessageContext ctx) {
