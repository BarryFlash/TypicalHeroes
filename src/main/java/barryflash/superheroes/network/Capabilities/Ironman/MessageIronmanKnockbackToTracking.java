...
public class MessageIronmanKnockbackToTracking extends MessageBase<MessageIronmanKnockbackToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanKnockbackToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanKnockbackToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanKnockbackToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageIronmanKnockbackToTracking message, EntityPlayer player, MessageContext ctx) {
