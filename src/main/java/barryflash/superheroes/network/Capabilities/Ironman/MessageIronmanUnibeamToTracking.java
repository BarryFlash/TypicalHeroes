...
public class MessageIronmanUnibeamToTracking extends MessageBase<MessageIronmanUnibeamToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanUnibeamToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanUnibeamToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanUnibeamToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageIronmanUnibeamToTracking message, EntityPlayer player, MessageContext ctx) {
