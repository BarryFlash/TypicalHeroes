...
public class MessageLeftLaserToTracking extends MessageBase<MessageLeftLaserToTracking> {
	...
	double evecy;
	double evecz;
	public MessageLeftLaserToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageLeftLaserToTracking(Vec3d svec, Vec3d evec) {
		this.svecx = svec.x;
		this.svecy = svec.y;
		this.svecz = svec.z;
		this.evecx = evec.x;
	...
	@Override
	public void handleClientSide(MessageLeftLaserToTracking message, EntityPlayer player) {
		...
		Utils.renderLaser(player, S, vector, 3.5F, 0.05F, new float[] {0.8F, 0.5F, 0.3F});
	}

	@Override
	public void handleServerSide(MessageLeftLaserToTracking message, EntityPlayer player, MessageContext ctx) {
