...
public class MessageIronmanRightRepulsorToTracking extends MessageBase<MessageIronmanRightRepulsorToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanRightRepulsorToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanRightRepulsorToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanRightRepulsorToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageIronmanRightRepulsorToTracking message, EntityPlayer player, MessageContext ctx) {
