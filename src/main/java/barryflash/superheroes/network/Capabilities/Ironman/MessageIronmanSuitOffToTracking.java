...
public class MessageIronmanSuitOffToTracking extends MessageBase<MessageIronmanSuitOffToTracking> {
	private boolean cap;
	private int playerID;
	public MessageIronmanSuitOffToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageIronmanSuitOffToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageIronmanSuitOffToTracking message, EntityPlayer player) {
		...
		ironmancap.setAnimationOff(message.cap);
	}

	@Override
	public void handleServerSide(MessageIronmanSuitOffToTracking message, EntityPlayer player, MessageContext ctx) {
