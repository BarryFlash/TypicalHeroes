...
public class MessageHulkDetransformToTracking extends MessageBase<MessageHulkDetransformToTracking> {
	private boolean cap;
	private int playerID;
	public MessageHulkDetransformToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageHulkDetransformToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageHulkDetransformToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageHulkDetransformToTracking message, EntityPlayer player, MessageContext ctx) {
