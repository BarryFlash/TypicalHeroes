...
public class MessageHulkHAlphaToTracking extends MessageBase<MessageHulkHAlphaToTracking> {
	private float cap;
	private int playerID;
	public MessageHulkHAlphaToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageHulkHAlphaToTracking(float cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageHulkHAlphaToTracking message, EntityPlayer player) {
		...
		hulkcap.setHAlpha(message.cap);
	}

	@Override
	public void handleServerSide(MessageHulkHAlphaToTracking message, EntityPlayer player, MessageContext ctx) {
