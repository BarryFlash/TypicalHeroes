...
public class MessageHulkToTracking extends MessageBase<MessageHulkToTracking> {
	private boolean cap;
	private int playerID;
	public MessageHulkToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageHulkToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageHulkToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageHulkToTracking message, EntityPlayer player, MessageContext ctx) {
