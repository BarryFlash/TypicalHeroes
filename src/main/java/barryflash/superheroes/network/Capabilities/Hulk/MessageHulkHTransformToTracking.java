...
public class MessageHulkHTransformToTracking extends MessageBase<MessageHulkHTransformToTracking> {
	private boolean cap;
	private int playerID;
	public MessageHulkHTransformToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageHulkHTransformToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageHulkHTransformToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageHulkHTransformToTracking message, EntityPlayer player, MessageContext ctx) {
