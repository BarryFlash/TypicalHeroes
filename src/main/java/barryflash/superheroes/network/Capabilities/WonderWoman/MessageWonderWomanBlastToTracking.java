...
public class MessageWonderWomanBlastToTracking extends MessageBase<MessageWonderWomanBlastToTracking> {
	private boolean cap;
	private int playerID;
	public MessageWonderWomanBlastToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageWonderWomanBlastToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageWonderWomanBlastToTracking message, EntityPlayer player) {
		...
		if (message.cap == true) {
			wonderwomancap.setBlast();
		} else {
			wonderwomancap.unsetBlast();
		}
	}

	@Override
	public void handleServerSide(MessageWonderWomanBlastToTracking message, EntityPlayer player, MessageContext ctx) {
