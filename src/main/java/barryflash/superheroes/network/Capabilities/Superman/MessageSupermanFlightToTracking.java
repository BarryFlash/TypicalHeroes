...
public class MessageSupermanFlightToTracking extends MessageBase<MessageSupermanFlightToTracking> {
	private boolean cap;
	private int playerID;
	public MessageSupermanFlightToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageSupermanFlightToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageSupermanFlightToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageSupermanFlightToTracking message, EntityPlayer player, MessageContext ctx) {
