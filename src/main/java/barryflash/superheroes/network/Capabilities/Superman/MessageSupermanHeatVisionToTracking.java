...
public class MessageSupermanHeatVisionToTracking extends MessageBase<MessageSupermanHeatVisionToTracking> {
	private boolean cap;
	private int playerID;
	public MessageSupermanHeatVisionToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageSupermanHeatVisionToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageSupermanHeatVisionToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageSupermanHeatVisionToTracking message, EntityPlayer player, MessageContext ctx) {
