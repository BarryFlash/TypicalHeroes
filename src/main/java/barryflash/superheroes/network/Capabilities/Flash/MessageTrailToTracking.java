...
public class MessageTrailToTracking extends MessageBase<MessageTrailToTracking> {
	private boolean cap;
	private int playerID;
	public MessageTrailToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageTrailToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageTrailToTracking message, EntityPlayer player) {
		...
		flashcap.setTrail(message.cap);
	}

	@Override
	public void handleServerSide(MessageTrailToTracking message, EntityPlayer player, MessageContext ctx) {
