...
public class MessageSuperSpeedToTracking extends MessageBase<MessageSuperSpeedToTracking> {
	private boolean cap;
	private int playerID;
	public MessageSuperSpeedToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageSuperSpeedToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageSuperSpeedToTracking message, EntityPlayer player) {
		...
		flashcap.setSuperSpeed(message.cap);
	}

	@Override
	public void handleServerSide(MessageSuperSpeedToTracking message, EntityPlayer player, MessageContext ctx) {
