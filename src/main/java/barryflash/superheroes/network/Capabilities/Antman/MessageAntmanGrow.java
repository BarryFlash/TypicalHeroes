...
public class MessageAntmanGrow extends MessageBase<MessageAntmanGrow> {
	private boolean cap;
	private int playerID;
	public MessageAntmanGrow() {
		// TODO Auto-generated constructor stub
	}
	public MessageAntmanGrow(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageAntmanGrow message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageAntmanGrow message, EntityPlayer player, MessageContext ctx) {
