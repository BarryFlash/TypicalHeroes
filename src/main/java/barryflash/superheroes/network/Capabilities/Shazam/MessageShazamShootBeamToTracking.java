...
public class MessageShazamShootBeamToTracking extends MessageBase<MessageShazamShootBeamToTracking> {
	private boolean cap;
	private int playerID;
	public MessageShazamShootBeamToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageShazamShootBeamToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageShazamShootBeamToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageShazamShootBeamToTracking message, EntityPlayer player, MessageContext ctx) {
