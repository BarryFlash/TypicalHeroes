...
public class MessageShazamLightningToTracking extends MessageBase<MessageShazamLightningToTracking> {
	private boolean cap;
	private int playerID;
	public MessageShazamLightningToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageShazamLightningToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageShazamLightningToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageShazamLightningToTracking message, EntityPlayer player, MessageContext ctx) {
