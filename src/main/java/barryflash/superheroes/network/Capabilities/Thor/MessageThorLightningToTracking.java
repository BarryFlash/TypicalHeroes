...
public class MessageThorLightningToTracking extends MessageBase<MessageThorLightningToTracking> {
	private boolean cap;
	private int playerID;
	public MessageThorLightningToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageThorLightningToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageThorLightningToTracking message, EntityPlayer player) {
		...
		thorcap.setLightningBeam(message.cap);
	}

	@Override
	public void handleServerSide(MessageThorLightningToTracking message, EntityPlayer player, MessageContext ctx) {
