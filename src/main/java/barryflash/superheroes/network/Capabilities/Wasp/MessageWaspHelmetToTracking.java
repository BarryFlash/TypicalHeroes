...
public class MessageWaspHelmetToTracking extends MessageBase<MessageWaspHelmetToTracking> {
	private boolean cap;
	private int playerID;
	public MessageWaspHelmetToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageWaspHelmetToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageWaspHelmetToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageWaspHelmetToTracking message, EntityPlayer player, MessageContext ctx) {
