...
public class MessageWaspLeftBlastToTracking extends MessageBase<MessageWaspLeftBlastToTracking> {
	private boolean cap;
	private int playerID;
	public MessageWaspLeftBlastToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageWaspLeftBlastToTracking(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageWaspLeftBlastToTracking message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageWaspLeftBlastToTracking message, EntityPlayer player, MessageContext ctx) {
