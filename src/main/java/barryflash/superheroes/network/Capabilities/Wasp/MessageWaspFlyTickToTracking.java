...
public class MessageWaspFlyTickToTracking extends MessageBase<MessageWaspFlyTickToTracking> {
	private int cap;
	private int playerID;
	public MessageWaspFlyTickToTracking() {
		// TODO Auto-generated constructor stub
	}
	public MessageWaspFlyTickToTracking(int cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageWaspFlyTickToTracking message, EntityPlayer player) {
		...
		waspcap.ticksFlying(message.cap);
	}

	@Override
	public void handleServerSide(MessageWaspFlyTickToTracking message, EntityPlayer player, MessageContext ctx) {
