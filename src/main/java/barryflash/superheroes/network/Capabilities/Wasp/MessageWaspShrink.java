...
public class MessageWaspShrink extends MessageBase<MessageWaspShrink> {
	private boolean cap;
	private int playerID;
	public MessageWaspShrink() {
		// TODO Auto-generated constructor stub
	}
	public MessageWaspShrink(boolean cap, int ID) {
		this.cap = cap;
		this.playerID = ID;
	}
	@Override
	...
	@Override
	public void handleClientSide(MessageWaspShrink message, EntityPlayer player) {
	...
	@Override
	public void handleServerSide(MessageWaspShrink message, EntityPlayer player, MessageContext ctx) {
